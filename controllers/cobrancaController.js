...
async function create(req, res, next) {
  try {
    ...
    const result = await pool.query(
      'INSERT INTO cobrancas (barbearia_id, assinatura_id, cliente_id, valor, data_vencimento, status, metodo) VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING *',
      [barbearia_id || req.user.barbearia_id, assinatura_id, cliente_id, valor, data_vencimento, status || 'pendente', metodo]
    );
